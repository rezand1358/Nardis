...
import 'package:nardis/components/ScrollableController.dart';
import 'package:nardis/components/scrollabe_bottom_sheet.dart';
...
import '../../ui/login/confirm_form.dart';
      ...
      return new Container(
        ...
        child: new Container(
          ...
          new Column(
            ...
            children: <Widget>[
              new ListTile(leading: new Icon(Icons.close),
                title: new Text(Translations.current.confirmSecurityCode()),
                onTap: () => null,
              ),
              new ConfirmLogin(),
              new DoConfirm()
