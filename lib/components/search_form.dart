...
class SearchForm extends StatefulWidget
{
  ...
  SearchForm({this.user,this.searchBloc});
...
registerEvent()
{
  RxBus.register<ChangeEvent>().listen((event) { 
  if(event.message==SoapOpersConstants.SEARCHDONE)
  {
    widget.searchBloc.dispatch(new LoadedSearchEvent());
  }
});
}
String searchText='';
  ...
  _doSearch()
  {
    if(searchText.isNotEmpty)
    {
      ...
      Scaffold.of(context).showSnackBar(new SnackBar(
        content:new Text(Translations.current.productnameisempty()) ,
