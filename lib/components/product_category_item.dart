...
ProductCategoryItem(this.context,this.item,this.imageUrl,this.mapItem);
CategoryItem item;
Map mapItem;
String imageUrl;
...
buildCategoryItem(){
    return   Container(
                    ...
                    color: Color(0xffFCDDE8),
                      border: Border.all(color: Color(0xffFCDDE8),style: BorderStyle.solid,width: 0.0),
                  ...
                  GestureDetector(
                    ...
                    onTap: () { 
                      item.cattype=SoapOpersConstants.SUBCATEGORY;
                      Navigator.pushReplacementNamed(context, '/subproducts',arguments:  item);
                    },
                    child:
                     ...
                     Row(
                      ...
                      new Text(mapItem['title'],style: new TextStyle(color: Colors.black,fontSize:16.0 ) ,)
                     ],),
                  ), 
