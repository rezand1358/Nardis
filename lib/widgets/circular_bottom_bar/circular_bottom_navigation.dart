...
import 'package:nardis/widgets/circular_bottom_bar/tab_item.dart';
          ...
          child: Center(
              child: Opacity(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontWeight: FontWeight.bold, color: widget.tabItems[pos].color,fontSize: 12.0),
                ),
              )),
        ),
        left: r.left,
